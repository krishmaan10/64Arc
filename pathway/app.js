...
function renderReview() {
  ...
  if (!review.suggestions.length && review.kind === 'grammar') panel.append(element('p', 'No matches in this limited checker. This does not mean the draft is error-free. Read it through yourself too.'));
